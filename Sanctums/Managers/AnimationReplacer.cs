...
namespace AlmanacClasses.LoadAssets
{
    public static class AnimationReplaceManager
    {
        ...
        public static void AddAnimationSet(AssetBundle AssetBundle, string attack1, string? attack2 = null, string? attack3 = null)
        { ;
            var newSet = new List<string> { attack1 };
            AllExternalAnimations[attack1] = AssetBundle.LoadAsset<AnimationClip>(attack1);
            if (attack2 != null) newSet.Add(attack2);
            if (attack3 != null) newSet.Add(attack3);
            if (attack2 != null) AllExternalAnimations[attack2] = AssetBundle.LoadAsset<AnimationClip>(attack2);
            if (attack3 != null) AllExternalAnimations[attack3] = AssetBundle.LoadAsset<AnimationClip>(attack3);
